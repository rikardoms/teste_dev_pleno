...
<body>
 <div class="container">
    ...
    <div class="row">
      <div class="col-md-9">
        <form action="<?php echo base_url('matricula/update');?>" name="post_form" id="post_form" method="post" accept-charset="utf-8">
            ...
            <?php if($alunos): ?>
              <select name= "aluno" id="aluno"  class="form-control">
                <?php foreach($alunos as $aluno): ?>
                  <?php if($aluno['id'] == $post['id_aluno']): ?>
                    <OPTION value=<?php echo $aluno['id']; ?> selected="selected"><?php echo $aluno['nome']; ?></OPTION>
                  <?php else: ?>
            ...
            <?php if($cursos): ?>
              <select name= "curso" id="curso"  class="form-control">
                <?php foreach($cursos as $curso): ?>
                  ...
                  <?php if($curso['id'] == $post['id_curso']): ?>
                    <OPTION value=<?php echo $curso['id']; ?> selected="selected" ><?php echo $curso['titulo']; ?></OPTION>
                  <?php else: ?>
